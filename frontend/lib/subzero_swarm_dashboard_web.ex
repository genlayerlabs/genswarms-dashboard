defmodule SubzeroSwarmDashboardWeb do
  @moduledoc """
  ...
  defp html_helpers do
    quote do
      ...
      alias SubzeroSwarmDashboardWeb.Layouts
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        endpoint: SubzeroSwarmDashboardWeb.Endpoint,
        router: SubzeroSwarmDashboardWeb.Router,
        statics: SubzeroSwarmDashboardWeb.static_paths()
    end
  end
